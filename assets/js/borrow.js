$( document ).ready(function() {
    $("#borrow").keyup(function(){
        ...
        var redirect=loc+'/index.php/borrow/borrowlist';
          $.ajax({
            type: "POST",
            url: redirect,
    ...
    $("#return").keyup(function(){
        var loc= document.getElementById("baseurl").value;
        var redirect=loc+'/index.php/borrow/returnlist';
          $.ajax({
            type: "POST",
            url: redirect,
    ...
    var loc= document.getElementById("baseurl").value;
    var redirect=loc+'/index.php/borrow/itemlist';
    $("#item").keyup(function(){
        $.ajax({
            type: "POST",
            url: redirect,
...
function saveBorrow(){
    ...
    var loc= document.getElementById("baseurl").value;
    var redirect = loc+'index.php/borrow/insert_borrow_details';
    if(itemid==""){
        alert('Please fill out Item.');
         ...
         $.ajax({
                ...
                success: function(output){
                    /*window.close();*/  
                    /*window.location=loc+'index.php/borrow/insert_borrow_details/';*/     
                    //alert(output);
                }
          });
    }
