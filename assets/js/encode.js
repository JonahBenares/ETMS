 $( document ).ready(function() {
    $("#accountability").keyup(function(){
        ...
        var redirect=loc+'/index.php/encode/accountability_list';
          $.ajax({
            type: "POST",
            url: redirect,
    ...
    $('.acquired').keyup(function(){
        ...
        var loc= document.getElementById("baseurl").value;
        var redirect=loc+'/index.php/encode/acquired_list';
            $.ajax({
                type: "POST",
                url: redirect,
...
function chooseCategory(){
    var loc= document.getElementById("baseurl").value;
    var redirect = loc+'index.php/encode/getCat';
...
function choosePrefix(){
    var loc= document.getElementById("baseurl").value;
    var redirect = loc+'index.php/encode/getPrefix';
