$( document ).ready(function() {
    $("#employee").keyup(function(){
        ...
        var redirect=loc+'/index.php/masterfile/employee_suggest';
          $.ajax({
            type: "POST",
            url: redirect,
    ...
    $(document).on('click', '#getSub', function(e){
        ...
        var loc= document.getElementById("baseurl").value;
        var redirect1=loc+'/index.php/masterfile/edit_subcat_modal';
        $.ajax({
              url: redirect1,
              type: 'POST',
              data: 'id='+uid,
...
function chooseLoc(){
    var loc= document.getElementById("baseurl").value;
    var redirect = loc+'index.php/masterfile/getLocation';
