 $( document ).ready(function() {
    $("#rec").keyup(function(){
        ...
        var redirect=loc+'/index.php/report/rec_list';
          $.ajax({
            type: "POST",
            url: redirect,
            data:'rec='+$(this).val(),
    ...
    $('.checked').keyup(function(){
        ...
        var loc= document.getElementById("baseurl").value;
        var redirect=loc+'/index.php/report/checked_list';
            $.ajax({
                type: "POST",
                url: redirect,
    ...
    $('.submitted').keyup(function(){
        ...
        var loc= document.getElementById("baseurl").value;
        var redirect=loc+'/index.php/report/submitted_list';
            $.ajax({
                type: "POST",
                url: redirect,
    ...
    $('.noted').keyup(function(){
        ...
        var loc= document.getElementById("baseurl").value;
        var redirect=loc+'/index.php/report/noted_list';
            $.ajax({
                type: "POST",
                url: redirect,
    ...
    $("#assign").keyup(function(){
        var loc= document.getElementById("baseurl").value;
        var redirect=loc+'/index.php/report/assignlist';
        $.ajax({
            type: "POST",
            url: redirect,
    ...
    var loc= document.getElementById("baseurl").value;
    var redirect=loc+'/index.php/report/itemlist';
    $("#item").keyup(function(){
        $.ajax({
            type: "POST",
            url: redirect,
    ...
    /*$(document).on('click', '#getID', function(e){
        ...
        var loc= document.getElementById("baseurl").value;
        var redir=loc+'/index.php/report/add_set_modal';
        $.ajax({
              url: redir,
              type: 'POST',
              data: 'id='+edid,
...
function remove_item(i){
 ...
 function saveAssign(){
    ...
    var loc= document.getElementById("baseurl").value;
    var redirect = loc+'index.php/report/insert_assign';
    if(assign==""){
...
function chooseCategory(){
    var loc= document.getElementById("baseurl").value;
    var redirect = loc+'index.php/report/getCat';
