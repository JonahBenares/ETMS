                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <input id="" name="acq_date[]" value = "<?php echo $d['date'];?>" type="date" class="form-control bor-radius5 cc-exp">
                                                    </div>
                                                    <div class="col-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        ...
                                                        <input id="" name="acn[]" type="text" class="form-control bor-radius5 cc-exp" value = "<?php echo ($d['asset_control_no']) ? $d['asset_control_no'] : $prefix."-".$location."-".$asset;?>" style = "pointer-events:none;" readonly>
                                                    </div>     
                                                    <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="remarks[]" id="" class="form-control bor-radius5" cols="30" rows="2"><?php echo $d['remarks'];?></textarea>
                                                </div>
