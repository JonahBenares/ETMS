                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">                                                 
                                            <div class="col-12">
                                                ...
                                                <textarea name="incident<?php echo $x;?>" class="form-control" id="" cols="30" rows="2" required></textarea>
                                            </div>
                                        </div>
                                        <div class="row">                                                 
                                            <div class="col-12">
                                                <label for="" class="control-label mb-1">Fully describe the damage done to the equipment:</label>
                                                <textarea name="damage_done<?php echo $x;?>" class="form-control" id="" cols="30" rows="2" required></textarea>
                                            </div>
                                        </div>
                                        <div class="row">                                                 
                                            <div class="col-12">
