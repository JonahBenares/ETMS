                    ...
                    <div class="card bor-radius shadow">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/report/insert_damage" method="POST">
                            ...
                            <div class="card-footer">
                                <center>
                                    <input type = "submit" class="btn btn-info btn-sm bor-radius10 btn-block" placeholder="Save" value="Proceed">
                                    ...
                                    <!-- <a href="<?php echo base_url(); ?>index.php/report/tag_damage_form">Proceed</a> -->
                                </center>
                            </div>
                        </form>
                    </div>
