            ...
            <div class="row">                
                <div class="col-lg-6 offset-lg-3">
                    <div class="card bor-radius shadow">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/masterfile/update_category" method="POST" novalidate="novalidate">
                            <div class="card-body card-block">
                                <label for="" class="control-label mb-1">Category:</label>
                                <?php foreach($category AS $cat){ ?>
                                <input id="" name="category" type="text" class="form-control bor-radius5" value = "<?php echo $cat->category_name;?>">
                            </div>
