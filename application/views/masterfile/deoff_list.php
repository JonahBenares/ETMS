                ...
                <div class="col-lg-12">
                    <div class="card bor-radius shadow">
                        <div class="card-header">
                            ...
                            <a><h4 class="m-l-5 m-b-10">Department / Office</h4></a>
                                    ...
                                    <tr>
                                        <td>                                            
                                            <div class="table-data-feature">
                                                <a href="<?php echo base_url(); ?>index.php/masterfile/deoff_update/<?php echo $dep->department_id?>" class="btn btn-info item btn-sm" data-toggle="tooltip" data-placement="top" title="Update">
                                                    <i class="fa fa-pencil-square-o"></i>
                                                </a>
                                                <a href="<?php echo base_url(); ?>index.php/masterfile/delete_department/<?php echo $dep->department_id;?>" onclick="confirmationDelete(this);return false;" class="btn btn-danger item btn-sm" data-toggle="tooltip" data-placement="top" title="Delete" title="Delete" alt='Delete'>
