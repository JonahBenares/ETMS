                ...
                <div class="col-lg-6 offset-lg-3">
                    <div class="card bor-radius shadow">
                        <div class="card-header">
                            ...
                            <strong>UPDATE</strong> Derpartment
                        </div>
                        <form action="<?php echo base_url(); ?>index.php/masterfile/update_deoff" method="POST" novalidate="novalidate">
                            <div class="card-body card-block">
                                <label for="" class="control-label mb-1">Department:</label>
                                <?php foreach($department AS $dep){ ?>  
                                <input id="" name="department" type="text" value = "<?php echo $dep->department_name;?>"  class="form-control bor-radius5" placeholder="">
                            </div>
