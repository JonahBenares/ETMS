...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 08, 2019 at 03:26 AM
...
(22, 'Annavi Lacambra', 'Accounting', 2, 'CENPRI-S-1001', 'Corporate Accountant', '0932-3649978', ''),
...
(31, 'Stephine David Severino', 'IT Department', 1, 'CENPRI-B-1002', 'Software Development Assistant', '0977-7106914', ''),
...
(45, 'Beverly  Ampog', 'Operations', 2, 'CENPRI-S-1004', 'Operations Analyst', '0995-3634548', ''),
...
(48, 'Alona Arroyo', 'Operations', 1, 'CENPRI-B-1003', 'Operations Planner', '0919-3725318', ''),
...
(75, 'Alex Manilla Jr.', 'Fuel Management', 1, 'CENPRI-B-1005', 'Fuel Tender', '0999-7353561', ''),
...
(79, 'Andro Ortega', 'Operations', 1, NULL, 'Shift Supervisor Trainee', '0932-2400663', ''),
...
(92, 'Alexander Tagarda', 'Operations', 2, 'CENPRI-S-1003', 'Control Room Operator', '0936-2138490', ''),
...
(111, 'test', NULL, 1, NULL, NULL, NULL, NULL),
(112, 'testing lng', NULL, 1, NULL, NULL, NULL, NULL),
(113, 'Test 123', NULL, 2, NULL, NULL, NULL, NULL),
(114, 'testing', NULL, 2, 'CENPRI-S-1001', NULL, NULL, NULL);
...
INSERT INTO `et_details` (`ed_id`, `et_id`, `serial_no`, `brand`, `model`, `type`, `unit_price`, `acquisition_date`, `date_issued`, `remarks`, `asset_control_no`, `damage`, `damage_of_unit`, `damage_remarks`, `acquired_by`) VALUES
(6, 2, '1001', 'brand1', 'model1', 'type1', '20000.00', '2019-02-08', '', '', 'FFE-TRA-1011', 0, '', '', 'aaa'),
(7, 1, '1002', 'brand2', 'model2', 'type2', '25000.00', '2019-02-08', '2019-02-08', '', 'FFE-TRA-1012', 0, '', '', 'bbb'),
(8, 2, '1003', 'brand3', 'model3', 'type3', '23000.00', '2019-02-08', '', '', 'FFE-TRA-1013', 0, '', '', 'ccc');
...
INSERT INTO `et_head` (`et_id`, `accountability_id`, `category_id`, `subcat_id`, `create_date`, `et_desc`, `qty`, `unit_id`, `department_id`, `user_id`) VALUES
(1, 3, 1, 1, '2019-02-08 09:48:44', 'Laptop', '1.00', 1, 1, 1),
(2, 0, 1, 1, '2019-02-08 10:25:25', 'Laptop', '2.00', 1, 1, 1);
...
INSERT INTO `return_details` (`rd_id`, `return_id`, `ed_id`, `date_issued`, `return_remarks`) VALUES
(14, 1, 6, '2019-02-08', ''),
(15, 1, 8, '2019-02-08', '');
...
INSERT INTO `return_head` (`return_id`, `ars_no`, `atf_no`, `et_id`, `quantity`, `return_date`, `accountability_id`, `received_by`, `return_remarks`, `create_date`) VALUES
(1, '2019-02-1001', '2019-1001', 1, '2.00', '2019-02-08', 3, 2, '', '2019-02-08 10:25:24');
...
(1, 1, 'Transportation Equipment', 'FFE-TRA'),
(2, 2, 'Hand Tools', 'TOO-HAN');
...
--
ALTER TABLE `atf_series`
MODIFY `atf_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
...
--
ALTER TABLE `employee_inclusion`
MODIFY `ei_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `employee_series`
--
ALTER TABLE `employee_series`
MODIFY `empser_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `et_details`
--
ALTER TABLE `et_details`
MODIFY `ed_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
...
--
ALTER TABLE `return_details`
MODIFY `rd_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=16;
--
